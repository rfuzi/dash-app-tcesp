...
githublink = 'https://github.com/rfuzi/dash-app-tcesp'
                        ...
                        html.Div(
                            ...
                            children=[
                                dcc.DatePickerSingle(
                                    ...
                                    max_date_allowed=dt(2014,1,1),
                                    initial_visible_month=dt(2014,1,1),
                                    date=dt(2014,1,1).date(),
                                ...
                                html.Div(
                                    ...
                                    children=[
                                        ...
                                        dcc.Dropdown(
                                            ...
                                            options=[
                                                {"label": key, "value": key}
                                                for key,value in mun_sp_2.items()
                                            ],
